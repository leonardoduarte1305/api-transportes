...
include::{snippets}/listar-todas-as-sedes/http-request.adoc[]

==== Example response

include::{snippets}/listar-todas-as-sedes/http-response.adoc[]

==== CURL request

include::{snippets}/listar-todas-as-sedes/curl-request.adoc[]

// [[resources-index-links]]
// ==== Links

// include::{snippets}/criar-sede/links.adoc[]


[[resources-Sedes]]
== Sedes REST Service

Endpoints Sedes provides the entry point into the service.

[[resources-sedes-get]]
=== Accessing the Sedes GET

A `GET` request is used to access the Sedes read.
...
[[resources-crud-post]]
=== Accessing the Sedes POST

A `POST` request is used to access the CRUD create.

==== Request structure

include::{snippets}/criar-sede/http-request.adoc[]

==== Example response

include::{snippets}/criar-sede/http-response.adoc[]

==== CURL request

include::{snippets}/criar-sede/curl-request.adoc[]
...
include::{snippets}/delete-sede/http-request.adoc[]

==== Path Parameters
include::{snippets}/delete-sede/path-parameters.adoc[]
